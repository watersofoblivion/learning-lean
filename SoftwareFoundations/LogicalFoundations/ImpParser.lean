...
namespace SoftwareFoundations.LogicalFoundations.ImpParser
  /-
  ## Internals
  -/
  ...
  partial def _root_.String.tokenize (s: String): Except Char (List Token) :=
...
end SoftwareFoundations.LogicalFoundations.ImpParser
